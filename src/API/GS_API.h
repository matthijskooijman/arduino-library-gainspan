...
typedef void (*GS_API_DataHandler)(uint8_t cid, uint8_t byte); ///< TCP and UDP connection data handling function pointer. cid is Connection ID of connection sending the data, byte is the data received.
